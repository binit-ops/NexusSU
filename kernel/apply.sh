...
# 6. Patch fs/open.c & fs/stat.c (Stealth hooks)
...
# 7. Patch fs/read_write.c (Procfs Maps & Mounts scrubbing)
...
# 8. Patch security/selinux/avc.c (MAC Bypass)
...
# 9. Patch security/selinux/hooks.c (Context Spoof)
...
# 10. Patch security/selinux/selinuxfs.c (Enforce Stealth)
